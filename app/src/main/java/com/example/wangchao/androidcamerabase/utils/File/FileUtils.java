package com.example.wangchao.androidcamerabase.utils.File;
...
public class FileUtils {
    ...
    private static File createDiskFile(Context context, String dirName, String fileName) {
        ...
        Log.d("camera_log","createDiskFile====cachePath====="+cachePath);///storage/sdcard0/Pictures
    ...
    public static String mergeMultipleVideoFile(Context context, String videoPath1, String videoPath2) {
        Log.i("camera_log", " mergeMultipleVideoFile  " + videoPath1 + " and " + videoPath2);
        ...
        try {
            ...
            fileList.clear();
            movieList.clear();
            Log.i("camera_log", " success merge file path==== " + currentFileName + " file.exists()= " + new File(currentFileName).exists());
        } catch (Exception e) {
            e.printStackTrace();
            Log.i("camera_log", " merge file exception： " + e.getMessage());
        }
